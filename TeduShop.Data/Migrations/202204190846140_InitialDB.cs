namespace TeduShop.Data.Migrations
{
    ...
    public partial class InitialDB : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OrderDatails", "ProductID", "dbo.Products");
            DropForeignKey("dbo.Products", "CategoryID", "dbo.ProductCategories");
            DropForeignKey("dbo.OrderDatails", "OrderID", "dbo.Orders");
            ...
            DropIndex("dbo.OrderDatails", new[] { "ProductID" });
            DropIndex("dbo.OrderDatails", new[] { "OrderID" });
